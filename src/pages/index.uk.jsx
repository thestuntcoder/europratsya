        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="mt-6 prose prose-indigo prose-lg text-gray-500 mx-auto">
            <p>
              ...
              також розміщуємо віддалені вакансії, які підходять для
              працівників, які проживають в Україні.
            </p>
            <p>
              Одна україномовна база даних про затребувані навички та вакансії
              по всій Європі – безкоштовно для кандидатів та роботодавців.
            </p>
          </div>
        </div>
      </div>
